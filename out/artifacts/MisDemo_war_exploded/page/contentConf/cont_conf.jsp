    ...
    <form action="" method="post" id="addfrm" name="addfrm">
        ...
        <table width="100%" border="0" cellspacing="4" cellpadding="4" style="font-size:15px;" class="table_input">
            <tr style="margin: 10px;">
                ...
                <td class="td_c"><input name="user.accountNo" id="accountNo" required="true" class="easyui-validatebox"
                                        maxlength="20"></td>
            </tr>

            <tr style="margin: 10px;">
                <td align="right" class="td_t">密码：</td>
                <td class="td_c"><input name="user.password" id="password" required="true" class="easyui-validatebox"
                                        type="password" maxlength="20"></td>
            </tr>
            <tr style="margin: 10px;">
                <td align="right" class="td_t">姓名：</td>
                <td class="td_c"><input name="user.name" id="name" required="true" class="easyui-validatebox"
                                        maxlength="20"></td>
            </tr>
            <tr style="margin: 10px;">
                <td align="right" class="td_t">Email：</td>
                <td class="td_c"><input name="user.email" id="email" class="easyui-validatebox" validtype="email"
                                        maxlength="30"></td>
            </tr>
            <tr style="margin: 10px;">
                <td align="right" class="td_t">电话：</td>
                <td class="td_c"><input name="user.phone" id="phone" class="easyui-validatebox" validtype="number"
                                        maxlength="20"></td>
            </tr>
        </table>
    </form>
